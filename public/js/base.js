...
$(document).ready(function(){
	...
	$('#trip-form').submit(function(e){
		...
		.done(function(data) {
			...
			var postHtml = "<div class='media text-left'> <div class='media-left'> <img class='media-object' src='"+data.tripImage+"' alt='...'></div><div class='media-body'><h3 class='media-heading'>"+data.tripCityState+"</h3><p>"+data.tripDescription+"</p><p>"+data.tripDate+"</p></div></div>";
